    ...
    [
      ...
      Enum.flat_map(recent, fn event ->
        ...
        [
          ...
          maybe_transcript_detail("  kind", details["kind"]),
          maybe_transcript_detail("  name", details["name"]),
          maybe_transcript_detail("  lifecycle", details["lifecycle"]),
          maybe_transcript_detail("  result_source", details["result_source"]),
          maybe_transcript_detail("  tool", details["tool_name"]),
          maybe_transcript_detail("  provider", details["provider"]),
          maybe_transcript_detail("  tool_use_id", details["tool_use_id"]),
          maybe_transcript_detail("  cached", if(details["cached"], do: "yes", else: nil)),
          maybe_transcript_detail("  replayed", if(details["replayed"], do: "yes", else: nil)),
