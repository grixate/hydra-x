defmodule HydraX.ReportTest do
    ...
    assert Enum.any?(hx_work_items_json, fn item ->
             ...
             item["goal"] == "Re-plan the constrained publish escalation." and
               ...
               follow_up["additional_summary_preview"] ==
                 "+1 more: Reviewer-guided recovery" and
  ...
  test "export_snapshot includes delegation batch posture" do
    ...
    assert markdown =~ "intervention_batches=2"
    ...
    assert markdown =~ "active_selected_intervention_portfolios=1"
    assert markdown =~ "inactive_selected_intervention_portfolios=0"
    ...
    assert markdown =~ "intervention=selected-active-heavy"
